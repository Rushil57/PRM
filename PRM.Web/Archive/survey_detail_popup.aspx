                ...
                <div>
                    <table class="StatementPopup">
                            ...
                            <td align="right">
                                <table id="tbl-cc">
                                    <tr style="height: 0.15in">
                                        <td colspan="4" width="325" style="text-align: center; vertical-align: middle; font-size: 0.7em; background-color: #fbeded;">IF PAYING BY CREDIT CARD, PLEASE FILL OUT THE FORM BELOW
                                        </td>
                                    </tr>
                                    <tr style="height: 0.3in;">
                                        <td colspan="3" width="">CARD NUMBER
                                        </td>
                                        <td>SECURITY ID
                                        </td>
                                    </tr>
                                    <tr style="height: 0.3in;">
                                        <td colspan="3">SIGNATURE
                                        </td>
                                        <td>EXP DATE
                                        </td>
                                    </tr>
                                    <tr style="height: 0.3in;">
                                        <td width="65">ACCOUNT NUM<div style="padding: 2px 0px 2px 0px; text-align: center; font-size: 1.8em;">
                                            <%=AccountID%>
                                        </div>
                                        </td>
                                        <td width="85">STATEMENT DATE<div style="padding: 2px 0px 2px 0px; text-align: center; font-size: 1.8em;">
                                            <%=StatementDate%>
                                        </div>
                                        </td>
                                        <td width="85">TOTAL DUE<div style="padding: 2px 0px 2px 0px; text-align: center; font-size: 1.8em;">
                                            <%=TotalDue%>
                                        </div>
                                        </td>
                                        <td>TOTAL PAID
                                ...
                                <table width="100%" style="text-align: left; vertical-align: top; font-size: 1.2em; margin: 16px 0px 0px 30px;">
                                    <tr style="line-height: 0.9em;">
                                        <td style="text-align: right;">MAKE CHECKS PAYABLE:
                                        </td>
                                        <td>&nbsp;&nbsp;
                                        </td>
                                        <td width="180">
                                    ...
                                    <tr style="line-height: 0.9em;">
                                        <td style="text-align: right;">SECURE ONLINE PAYMENTS:
                                        </td>
                                        <td>&nbsp;&nbsp;
                                        </td>
                                        <td>
                                    ...
                                    <tr style="line-height: 0.9em;">
                                        <td style="text-align: right;">PAY-BY-PHONE SERVICE:
                                        </td>
                                        <td>&nbsp;&nbsp;
                                        </td>
                                        <td>
                            ...
                            <td>
                                <table id="tbl-eob" style="margin-top: -8px; font-size: 1.1em;">
                                    ...
                                    <tr>
                                        ...
                                        <td width="85" style="border-left: 1px solid darkred;">Co-Pay/Co-Ins:
                                        </td>
                                        <td>
                                            <%=EOBCoPay%>
                                    Visit /
                                    ...
                                    <%=EOBPatientRelation%>
                                        ...
                                        <td style="border-left: 1px solid darkred;">Deductible:
                                        </td>
                                        <td>
                                            <%=EOBDeductMet%>
                                    /
                                    ...
                                    <tr>
                                        ...
                                        <td style="border-left: 1px solid darkred;">Out-of-Pocket:
                                        </td>
                                        <td>
                                            <%=EOBStopLossYTD%>
                                    /
                                    ...
                                    <tr>
                                        ...
                                        <td style="border-left: 1px solid darkred;">Visit Limits:
                                        </td>
                                        <td>
                                            <%=EOBVisitsCurrent%>
                                    /
                        ...
                        <tr style="height: 0.3in; text-align: center;">
                            <td colspan="2">- - - - - - - - - - - - - - - - PLEASE DETACH HERE AND RETURN THIS TOP PORTION WITH
                        YOUR PAYMENT - - - - - - - - - - - - - - - -
                            </td>
                        </tr>
                            ...
                            <td colspan="2">
                                <table id="tbl-hdr">
                                    <tr style="text-align: center; font-weight: bold; background-color: #d4e0f2;">
                                        ...
                                        <td width="100">INVOICE DATE
                                        </td>
                                        <td width="100">DUE DATE
                                        </td>
                                        <td width="141">STATUS
                                        </td>
                                        <td width="80">TOTAL DUE
                                        </td>
                                    </tr>
                            ...
                            <td colspan="2">
                                <table id="tbl-desc">
                                    <tr class="tr-hdr" style="height: 0.1in; text-align: center; font-weight: bold; background-color: #d4e0f2;">
                                        <td class="td-hdr" width="75">DATE
                                        </td>
                                        <td class="td-hdr">DESCRIPTION OF SERVICE
                                        </td>
                                        <td class="td-hdr" width="70">CHARGES
                                        </td>
                                        <td class="td-hdr" width="70">INS PAY
                                        </td>
                                        <td class="td-hdr" width="70">PATIENT
                                        </td>
                                        <td class="td-hdr" width="80">BALANCE
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="tr-ftr" style="height: 0.2in; font-size: 1.2em; font-weight: bold;">
                                        <td class="td-hdr" colspan="2" style="border: 0px; text-align: left; font-weight: normal;">
                                            <div style="margin: 2px 0px -5px 0px;">
                                                ...
                                                <%=StatementIDfromDB%>-<%=InvoiceID%>
                                            </div>
                                        </td>
                                        <td class="td-hdr" colspan="3" style="border: 0px; text-align: right;">YOUR RESPONSIBILITY &nbsp; &nbsp;
                                        </td>
