    ...
    <form id="form1" runat="server">
                            ...
                            <div>
                                <div style="margin-top: 15px; margin-left: 70px;">
                                  <a href="#" onclick="$find('{0}').close(true);">
                                    ...
                                    <a href="javascript:;" onclick="$find('{0}').close(false);"> <img src="../Content/Images/btn_cancel_small.gif" alt="Cancel" /></a>
                                </div>
                            </div>
                        </div>
                    </ConfirmTemplate>
        ...
        function validateFlagBillEmails() {
            ...
            function removeStatement(obj) {
                ...
                radconfirm('Are you sure you want to remove the selected statement? <br>Any balance will be due in full by the statement due date. <br><br>This update is immediate even if other changes are cancelled.', removeSelectedStatement, 500, 150, null, '', '../Content/Images/warning.png');
                return false;
            }
