<%@ Page Language="C#" AutoEventWireup="true" CodeFile="printStatements_popup.aspx.cs" Inherits="report_printStatements_popup" %>
        ...
        <div>
            <table class="CareBluePopup">
                ...
                <tr>
                    <td>
                        <h4p>
                        Statement results are displayed according to the filters as indicated.
                    </h4p>
                    </td>
                </tr>
                <tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table style="margin: 0px auto;" border="0">
                                        <tr>
                                            <td colspan="2" valign="top" height="30" width="500">
                                                <span style="font-size: 2.0em; font-weight: 600; color: #002897;">Statement Report for <%=PracticeAbbr%></span>
                                            </td>
                                            <td>
                                        ...
                                        <tr style="font-size: 1.2em;">
                                            <td>Open Balance:</td>
                                            <td><asp:Label ID="lblOBMin" runat="server"></asp:Label> - <asp:Label ID="lblOBMax" runat="server"></asp:Label></td>
                                        </tr>
                                        <tr style="font-size: 1.2em;">
                                            <td>Prepared by:</td>
                                    ...
                                    <table width="100%" style="margin: 0px auto; font-size:0.6em;" border="0">
                                        <tr>
                                            <td>
                                                    <telerik:radgrid id="grdStatements" runat="server" allowsorting="True" allowpaging="True" onneeddatasource="grdStatements_NeedDataSource">
                                                        <MasterTableView AllowPaging="False" AutoGenerateColumns="False">
                                                            <Columns>
                                                                <telerik:GridBoundColumn HeaderText="ID" DataField="StatementID">
                                                                ...
                                                                <telerik:GridBoundColumn HeaderText="Paid" DataField="Payments$">
                                                                </telerik:GridBoundColumn>
                                                                <telerik:GridBoundColumn HeaderText="Balance" DataField="Balance$">
                                                                </telerik:GridBoundColumn>
                                                                <telerik:GridBoundColumn HeaderText="Due" DataField="DueDate">
                                                                </telerik:GridBoundColumn>
