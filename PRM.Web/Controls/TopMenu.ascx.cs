...
public partial class Controls_TopMenu : System.Web.UI.UserControl
{
    ...
    private void FillMenu()
    {
        ...
        //Adding Menu Item
        var menuItemSurveys = new RadMenuItem { Text = "Surveys" };
        var surveysMenuItems = activeMenus.Where(res => res.MenuName.Contains("Survey"));
        foreach (var surveyMenuItem in surveysMenuItems)
        {
            menuItemSurveys.Items.Add(new RadMenuItem { Text = surveyMenuItem.PageName, NavigateUrl = surveyMenuItem.NavigateURL });
        }
        ...
        if (surveysMenuItems.Any())
            radTopMenu.Items.Add(menuItemSurveys);
