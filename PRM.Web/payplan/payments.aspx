...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            <div class="hdrTitle">
                <h1>Payment Plans Scheduled Payments</h1>
            </div>
            <div class="bodyMain">
                <h2>Listed below are upcoming scheduled pending payments for payment plans and recently
                    completed payments.</h2>
                <div>
                    <br />
                    <h3>Pending Payments
                    ...
                    <telerik:radgrid id="grdPendingPayments" runat="server" allowsorting="True" allowpaging="True"
                        pagesize="20" onneeddatasource="grdPendingPayments_NeedDataSource" onitemcommand="grdPendingPayments_OnItemCommand">
                        <MasterTableView AutoGenerateColumns="False" DataKeyNames="StatementID, Balance, BlueCreditID, PaymentPlanID, PatientID, AccountID">
                            <Columns>
                                <telerik:GridBoundColumn HeaderText="Scheduled Date" DataField="NextPayDate" DataFormatString="{0:MM/dd/yyyy}">
                                ...
                                <telerik:GridButtonColumn CommandName="ViewStatement" UniqueName="ViewStatement" HeaderText="View" ButtonType="ImageButton"
                ...
                <div>
                    ...
                    <telerik:radgrid id="grdPaymentHistory" runat="server" allowsorting="True" allowpaging="True"
                        pagesize="20" onneeddatasource="grdPaymentHistory_NeedDataSource" onitemcommand="grdPaymentHistory_OnItemCommand">
            ...
            <telerik:radwindowmanager id="RadWindowManager1" showcontentduringload="True" visiblestatusbar="False"
                ...
                style="z-index: 3000">
                <Windows>
                    <telerik:RadWindow runat="server" ID="popupTransactionDetails" CssClass="customprintbutton"
                        Width="800px" Height="800px" OnClientShow="OnClientShow" NavigateUrl="~/report/transaction_popup.aspx"
                        DestroyOnClose="True">
                    </telerik:RadWindow>
