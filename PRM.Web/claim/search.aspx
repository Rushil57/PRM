                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="editor-field">
                                                        <telerik:RadComboBox ID="cmbTypes" runat="server" Width="200px" EmptyMessage="All Types"
                                                            AllowCustomText="False" MarkFirstMatch="True" DataTextField="Abbr" DataValueField="ClaimTypeID">
                                                        </telerik:RadComboBox>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    ...
                                                    <div class="editor-field">
                                                        <telerik:RadComboBox ID="cmbStatus" runat="server" Width="200px" EmptyMessage="All status"
                                                            DataTextField="Abbr" DataValueField="ClaimStatusTypeID" AllowCustomText="False"
                                                            MarkFirstMatch="True">
                                                        </telerik:RadComboBox>
                                                    </div>
                                                </div>
                    ...
                    <tr>
                        <td colspan="2">
                            <telerik:RadGrid ID="grdClaims" runat="server" AllowSorting="True" AllowPaging="True"
                                PageSize="20" OnNeedDataSource="grdClaims_NeedDataSource" OnItemCommand="grdClaims_OnItemCommand">
                                <MasterTableView AutoGenerateColumns="False" DataKeyNames="ClaimID" NoMasterRecordsText="&nbsp; <br>&nbsp; &nbsp; No results match your search. If filters are in use, clear the values and try again.<br>&nbsp;">
                                    <Columns>
