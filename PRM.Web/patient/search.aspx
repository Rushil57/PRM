            ...
            <div class="bodyMain">
                ...
                <div style="overflow-x: auto">
                    <telerik:radgrid id="grdPatients" runat="server" allowsorting="True" allowpaging="True"
                        onneeddatasource="grdPatients_NeedDataSource" pagesize="20" onitemcommand="grdPatients_ItemCommand"  onitemdatabound="grdPatients_ItemDataBound"
                        enableembeddedbasestylesheet="True" enableembeddedskins="True" skin="Default">
                        <ClientSettings EnableRowHoverStyle="true" EnablePostBackOnRowClick="true">
                            <Selecting AllowRowSelect="True"></Selecting>
                        </ClientSettings>
                        <MasterTableView AutoGenerateColumns="False" DataKeyNames="PatientID,AccountID,AWVSurveyURL,PHQSurveyURL,AWVSurveyStatusTypeID,PHQSurveyStatusTypeID" NoMasterRecordsText="&nbsp; <br>&nbsp; &nbsp; No patients match your search. Start typing a first or last name and results will update immediately.<br>&nbsp;">
                            <Columns>
                                ...
                                <telerik:GridButtonColumn CommandName="AWV" UniqueName="AWV" HeaderText="AWV" ButtonType="ImageButton">
                                </telerik:GridButtonColumn>
                                <telerik:GridButtonColumn CommandName="PHQ" UniqueName="PHQ" HeaderText="PHQ" ButtonType="ImageButton">
                                </telerik:GridButtonColumn>
                            </Columns>
                        </MasterTableView>
                    </telerik:radgrid>
