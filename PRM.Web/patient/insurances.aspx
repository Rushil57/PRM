        ...
        <table width="100%">
            ...
            <tr>
                <td>
                    ...
                    <div class="form-row">
                        <div class="editor-label">
                            <asp:Label runat="server">Enrollment:</asp:Label>
                        </div>
                        <div class="editor-field">
                            <telerik:raddatepicker id="dtEnrollment" mindate="1900/1/1" runat="server">
                            </telerik:raddatepicker>
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="dtEnrollment" Display="Dynamic"
                                SetFocusOnError="True" CssClass="failureNotification" ToolTip="Enrollment date is required."
                                ErrorMessage="Enrollment date is required." ValidationGroup="InsuranceValidationGroup">*</asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="editor-label">
