...
<body>
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="updPanelEligility" runat="server">
            <ContentTemplate>
                ...
                <table class="CareBluePopup" width="100%">
                    ...
                    <tr>
                        <td colspan="2">
                            <h3p><asp:Label ID="lblStatementFullName" runat="server"></asp:Label></h3p>
                        </td>
                    </tr>
                </table>
                        ...
                        <tr>
                            <td class="ExtraPad">
                                ...
                                <div class="boxInputL" style="margin: 0px 0px -10px 50px;">
                                    <img id="Img1" src="../content/Images/help.png" height="14" width="14" runat="server"
                                        alt="help" onclick="gotoPayPlan()" />
                        ...
                        <tr>
                            <td>
                                ...
                                <a href="javascript:;" onclick="closePopup()">
                                    <img src="../content/Images/btn_cancel_small.gif" alt="Cancel" class="btn-pop-cancel" /></a>
                                ...
                                <asp:ImageButton ID="btnSubmit" runat="server" ImageUrl="../content/Images/btn_submit_small.gif"
                                    CssClass="btn-pop-submit" OnClientClick="enableDisableButton(this); return false;" OnClick="btnSubmit_Click" />
                            </td>
                        </tr>
                    </table>
                </div>
        ...
        function reloadPage(arg) {
            GetRadWindow().BrowserWindow.closeRefresh();
            closePopup();
        }
        ...
        function ConfirmDelete() {
            radconfirm('Are you sure you want to cancel? <br/>The outstanding balance will be due in full by the due date.', validateRequest, 350, 150, null, '', '../Content/Images/warning.png');
        }
