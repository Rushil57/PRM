<%@ Page Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="transactions.aspx.cs"
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <asp:UpdatePanel ID="updPanelEligility" runat="server">
        <ContentTemplate>
            ...
            <div class="bodyMain">
                <h2>All patient account transactions are listed below. Information can be sorted by
                    clicking on the column header, and the View icon will show details about any
                    <br />
                    specific transaction. If the transaction is able to be changed or cancelled, the
                    modify icon will be active.</h2>

                <div style="margin-top: -10px;">
                    <div style="position: absolute; top: 57px; font-weight: 700;">
                        <table>
                            <tr>
                                <td>&nbsp;</td>
                                <td valign="bottom">
                    ...
                    <tr>
                        <td colspan="3">
                            <telerik:radgrid id="grdTransactions" runat="server" allowsorting="True" allowpaging="True"
                                onprerender="grdTransactions_OnPreRender" showgrouppanel="False" pagesize="20"
                                onneeddatasource="grdTransactions_NeedDataSource" onitemcommand="grdTransactions_OnItemCommand"
                                ondatabound="grdTransactions_OnDataBound" onitemdatabound="grdTransactions_ItemDataBound">
                               <MasterTableView AutoGenerateColumns="False" DataKeyNames="TransactionID, StatementID, FlagLocked, GroupID, FlagPending, FlagVeryOld, FlagModify, PendingTypeAbbr">
                                    <Columns>
                                        <telerik:GridBoundColumn HeaderText="Transaction" DataField="TransactionRef">
                                       ...
                                       <telerik:GridBoundColumn HeaderText="Patient" DataField="PatientName">
                                        ...
                                        <telerik:GridButtonColumn CommandName="Modify" HeaderText="Modify" ButtonType="ImageButton"
                ...
                <telerik:radwindowmanager id="RadWindow" showcontentduringload="True" visiblestatusbar="False"
                    visibletitlebar="True" reloadonshow="True" runat="Server" width="800px" height="650px"
                    ...
                    <Windows>
                        <telerik:RadWindow runat="server" ID="popupModifyTransaction" NavigateUrl="~/report/modifyTransaction_popup.aspx"
                            Width="800" Height="450" DestroyOnClose="True">
                        </telerik:RadWindow>
