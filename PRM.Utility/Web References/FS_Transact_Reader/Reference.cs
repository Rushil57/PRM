...
namespace PatientPortal.Utility.FS_Transact_Reader {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="SmartPayments3Soap", Namespace="http://TPISoft.com/SmartPayments/")]
    public partial class SmartPayments3 : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public SmartPayments3() {
            this.Url = global::PatientPortal.Utility.Properties.Settings.Default.PatientPortal_Utility_FS_Transact_Reader_SmartPayments3;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://TPISoft.com/SmartPayments/ProcessBatch", RequestNamespace="http://TPISoft.com/SmartPayments/", ResponseNamespace="http://TPISoft.com/SmartPayments/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public Response ProcessBatch(string UserName, string Password, string TransType, string PaymentType, string BatchID, string BatchStatus, string PNRef, string ExtData) {
        ...
        /// <remarks/>
        public void ProcessBatchAsync(string UserName, string Password, string TransType, string PaymentType, string BatchID, string BatchStatus, string PNRef, string ExtData) {
            this.ProcessBatchAsync(UserName, Password, TransType, PaymentType, BatchID, BatchStatus, PNRef, ExtData, null);
        }
        
        /// <remarks/>
        public void ProcessBatchAsync(string UserName, string Password, string TransType, string PaymentType, string BatchID, string BatchStatus, string PNRef, string ExtData, object userState) {
            ...
            this.InvokeAsync("ProcessBatch", new object[] {
                        ...
                        BatchStatus,
                        PNRef,
                        ExtData}, this.ProcessBatchOperationCompleted, userState);
        }
